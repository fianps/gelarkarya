      ...
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          ...
          <ul class="menu-inner py-1">
            <!-- Dashboard -->
            <li class="menu-item {{ ($title === 'Data Lengkap' || $title === 'Data Finalis' || $title === 'Detail Peserta') ? 'active open' : '' }}">
              <a href="javascript:void(0);" class="menu-link menu-toggle">
                <i class="menu-icon tf-icons bx bx-bar-chart-alt-2"></i>
                <div data-i18n="Penilaian">Penilaian</div>
              </a>
              <ul class="menu-sub">
                <li class="menu-item  {{ ($title === 'Data Lengkap' || $title === 'Detail Peserta') ? 'active' : '' }}">
                  <a href="/penilaian" class="menu-link">
                    <div data-i18n="Without menu">Data Lengkap</div>
                  </a>
                </li>
                <li class="menu-item  {{ ($title === 'Data Finalis') ? 'active' : '' }}">
                  <a href="/finalis" class="menu-link">
                    <div data-i18n="Without navbar">Juri Tamu</div>
                  </a>
                </li>
              </ul>
            </li>
              ...
              <ul class="navbar-nav flex-row align-items-center ms-auto">
                ...
                <li class="nav-item navbar-dropdown dropdown-user dropdown">
                  ...
                  <ul class="dropdown-menu dropdown-menu-end">
                      ...
                      <a class="dropdown-item" href="#">
                        <div class="d-flex">
                          ...
                          <div class="flex-grow-1">
                            ...
                            <small class="text-muted">Juri</small>
                          </div>
                        </div>
                      </a>
                    </li>
                    ...
                    <li>
                      <form class="dropdown-item" action="/logout" method="POST" onsubmit="return confirm('Apakah Anda yakin ingin keluar?')">
                        @csrf
                        <i class="bx bx-power-off me-2"></i>
                        <button type="submit" class="align-middle">Keluar</button>
                      </form>
                    </li>
                  </ul>
                </li>
